...
int contactoFiltrarEdad(void *dato) {
  Contacto *cont = (Contacto*) dato;
  return (cont->edad > 58 ? 1 : 0);
}
...
int main() {
  ...
  listaFiltrada = glist_filtrar(lista, (FuncionCopia)contacto_copia, contactoFiltrarEdad);
  puts("Lista de contactos filtrada");
